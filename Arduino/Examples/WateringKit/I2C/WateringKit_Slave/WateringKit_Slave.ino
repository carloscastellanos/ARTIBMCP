...
void waterFlower(int pompNumber) {
  digitalWrite(relays[pompNumber-1], HIGH);
  relaysFlags[pompNumber-1] = 1;
  delay(50);
...
void stopWater(int pompNumber) {
  digitalWrite(relays[pompNumber-1], LOW);
  relaysFlags[pompNumber-1] = 0;
  delay(50);
